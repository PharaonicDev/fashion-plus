...
<a class="font-size13 gray-black transition3 hover-color-green" href=new.html>
<img src="images/home/1-1.jpg" alt="sorry web not allowed image"/>
English
</a>
</li>
<li class=transition3>
<a class="font-size13 gray-black transition3 hover-color-green" href="ar/new.html">
...
<li class=float-left-jq>
<a class="transition3 cap  active color-green-black hover-color-green" href="#">New</a>
<div class=hidden-md>
<span class=transition2></span>
<span class=transition2></span>
</div>
...
<div class=new>
<div class=container-our>
<div class=ABOUT-JAKIRO>
<div class=container>
<div class="img float-left-jq">
<div class="OUR-HISTORY float-left-jq">
<h6 class=upper>OUR HISTORY</h6>
</div>
<div class="img-inset float-left-jq">
<img src="images/new/1-home_v2_img.jpg" alt="sorry browser not allowed img"/>
</div>
<div class=cf></div>
</div>
<div class="container-img float-left-jq">
<h3>ABOUT JAKIRO</h3>
<p>Founded in 2012, Jakiro grew out of a love affair with the independent fashion, open attitude, unexpected pairings, and appreciation for all things ecclectic and unique. A fusion of Bohemian chic, Indie love, and edgy Rock, Jakiro brings you a finely curated assortment of vintage-inspired clothing, accessories, shoes, and even decorative items for your home.</p>
<span>John Harry</span>
</div>
<div class=cf></div>
</div>
</div>
...
<ul>
<li class="float-left-jq upper active" data-filter=.BLAZERS>BLAZERS</li>
<li class="float-left-jq upper" data-filter=.JACKET>JACKET</li>
<li class="float-left-jq upper" data-filter=.PARKA>PARKA</li>
</ul>
</div>
<div class="content-BLAZERS mixitup-BLAZERS">
<ul>
<li class="img-1 mix float-left-jq BLAZERS JACKET">
<div>
<div class=img>
<a href="#" class=img-link>
<img src="images/new/2-k11-400x510.jpg" alt="sorry browser not allowed img"/>
<span class=hover-img></span>
</a>
<ul class="social transition3">
<li class=float-left-jq>
<a class=transition3 href="#"></a>
<ul class=transition3>
<li>Quick view</li>
</ul>
</li>
...
<h3><a href="#" class=transition2>Stretch Wool Jacket</a></h3>
<span class=price>$275.50</span>
<a href="#" class="upper add transition3">add to cart</a>
</div>
</div>
</li>
<li class="img-2 mix float-left-jq BLAZERS JACKET">
<div>
<div class=img>
<a href="#" class=img-link>
<img src="images/new/5-j1-400x510.jpg" alt="sorry browser not allowed img"/>
<span class=hover-img></span>
</a>
<ul class="social transition3">
<li class=float-left-jq>
...
<div class=content-img>
<h3><a href="#" class=transition2>Obey Slim Fit Blazer</a></h3>
<span class=price>$229.95</span>
<a href="#" class="upper add transition3">add to cart</a>
</div>
</div>
</li>
<li class="img-3 mix float-left-jq BLAZERS JACKET">
<div>
<div class=img>
<a href="#" class=img-link>
<img src="images/new/7-o1-400x510.jpg" alt="sorry browser not allowed img"/>
<span class=hover-img></span>
</a>
<ul class="social transition3">
<li class=float-left-jq>
...
<div class=content-img>
<h3><a href="#" class=transition2>Metalic Texture Blazer</a></h3>
<span class=price>$149.95</span>
<a href="#" class="upper add transition3">add to cart</a>
</div>
</div>
</li>
<li class="img-4 mix float-left-jq BLAZERS">
<div>
<div class=img>
<a href="#" class=img-link>
<img src="images/new/9-e1-400x510.jpg" alt="sorry browser not allowed img"/>
<span class=hover-img></span>
</a>
<ul class="social transition3">
<li class=float-left-jq>
...
<div class=content-img>
<h3><a href="#" class=transition2>Fleece Blazer in Navy</a></h3>
<span class=price>$200.95</span>
<a href="#" class="upper add transition3">add to cart</a>
</div>
</div>
</li>
<li class="img-5 mix float-left-jq BLAZERS">
<div>
<div class=img>
<a href="#" class=img-link>
<img src="images/new/11-d1-400x510.jpg" alt="sorry browser not allowed img"/>
<span class=hover-img></span>
</a>
<ul class="social transition3">
<li class=float-left-jq>
...
<div class=content-img>
<h3><a href="#" class=transition2>Herringbone Breasted Blazer</a></h3>
<span class=price>$220.00</span>
<a href="#" class="upper add transition3">add to cart</a>
</div>
</div>
</li>
<li class="img-6 mix float-left-jq BLAZERS">
<div>
<div class=img>
<a href="#" class=img-link>
<img src="images/new/13-h1-400x510.jpg" alt="sorry browser not allowed img"/>
<span class=hover-img></span>
</a>
<ul class="social transition3">
<li class=float-left-jq>
...
<span class="upper sale">sale!</span>
</div>
<div class=content-img>
<h3><a href="#" class=transition2>Long Wool Overcoat</a></h3>
<span class=price>$125.00 <span class=sale>$130.00</span></span>
<a href="#" class="upper add transition3">add to cart</a>
</div>
</div>
</li>
<li class="img-7 mix float-left-jq BLAZERS">
<div>
<div class=img>
<a href="#" class=img-link>
<img src="images/new/15-a1-400x510.jpg" alt="sorry browser not allowed img"/>
<span class=hover-img></span>
</a>
<ul class="social transition3">
<li class=float-left-jq>
...
<div class=content-img>
<h3><a href="#" class=transition2>Jersey Collarless Blazer</a></h3>
<span class=price>$140.00 <span class=sale>$125.30</span></span>
<a href="#" class="upper add transition3">add to cart</a>
</div>
</div>
</li>
<li class="img-8 mix float-left-jq BLAZERS">
<div>
<div class=img>
<a href="#" class=img-link>
<img src="images/new/17-f1-400x510.jpg" alt="sorry browser not allowed img"/>
<span class=hover-img></span>
</a>
<ul class="social transition3">
<li class=float-left-jq>
...
<div class=content-img>
<h3><a href="#" class=transition2>Slim Collarless Blazer</a></h3>
<span class=price>$125.30 <span class=sale>$140.00</span></span>
<a href="#" class="upper add transition3">add to cart</a>
</div>
</div>
</li>
<li class="img-9 mix float-left-jq JACKET" style="display: none">
<div>
<div class=img>
<a href="#" class=img-link>
<img src="images/new/19-i1-400x510.jpg" alt="sorry browser not allowed img"/>
<span class=hover-img></span>
</a>
<ul class="social transition3">
<li class=float-left-jq>
...
<div class=content-img>
<h3><a href="#" class=transition2>Asymmetrical Zip Poncho</a></h3>
<span class=price>$64.50</span>
<a href="#" class="upper add transition3">add to cart</a>
</div>
</div>
</li>
<li class="img-10 mix float-left-jq JACKET" style="display: none">
<div>
<div class=img>
<a href="#" class=img-link>
<img src="images/new/21-b1-400x510.jpg" alt="sorry browser not allowed img"/>
<span class=hover-img></span>
</a>
<ul class="social transition3">
<li class=float-left-jq>
...
<div class=content-img>
<h3><a href="#" class=transition2>Denim Kimono Jacket</a></h3>
<span class=price>$150.00 <span class=sale>$195.50</span></span>
<a href="#" class="upper add transition3">add to cart</a>
</div>
</div>
</li>
<li class="img-11 mix float-left-jq PARKA" style="display: none">
<div>
<div class=img>
<a href="#" class=img-link>
<img src="images/new/23-m1-400x510.jpg" alt="sorry browser not allowed img"/>
<span class=hover-img></span>
</a>
<ul class="social transition3">
<li class=float-left-jq>
...
<div class=content-img>
<h3><a href="#" class=transition2>Parka with Fur Hood</a></h3>
<span class=price>$390.00</span>
<a href="#" class="upper add transition3">add to cart</a>
</div>
</div>
</li>
<li class="img-12 mix float-left-jq PARKA" style="display: none">
<div>
<div class=img>
<a href="#" class=img-link>
<img src="images/new/25-n1-400x500.jpg" alt="sorry browser not allowed img"/>
<span class=hover-img></span>
</a>
<ul class="social transition3">
<li class=float-left-jq>
...
<div class=content-img>
<h3><a href="#" class=transition2>Obey Parka in Khaki</a></h3>
<span class=price>$390.00</span>
<a href="#" class="upper add transition3">add to cart</a>
</div>
</div>
...
<h5>GET THE LATEST FROM JAKIRO STORE</h5>
<p>Sign up for our newsletter</p>
<div>
<input type=email class=float-left-jq placeholder="Enter your email..."/>
<button type=button class="float-left-jq upper transition3">Subscribe</button>
</div>
</div>
</div>
</div>
