                            ...
                            <li class="float-left-jq hover-color-green">
                                ...
                                <ul class=transition3>
                                    <li class=transition3>
                                        <a class="font-size13 gray-black transition3 hover-color-green" href=accessories.html>
<img src="../images/home/1-1.jpg" alt="sorry web not allowed image"/>
English
</a>
                                    </li>
                                    <li class=transition3>
                                        <a class="font-size13 gray-black transition3 hover-color-green" href="../ar/pages/accessories.html">
                            ...
                            <aside class=float-left-jq>
                                <div class=inset-aside>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href=men.html class="float-left-jq transition3">Men</a>
                                            <span class="count float-right-jq transition3">5</span>
                                        </li>
                                        <li>
