                            ...
                            <li class="float-left-jq hover-color-green">
                                ...
                                <ul class=transition3>
                                    <li class=transition3>
                                        <a class="font-size13 gray-black transition3 hover-color-green" href=2.html>
<img src="../images/home/1-1.jpg" alt="sorry web not allowed image"/>
English
</a>
                                    </li>
                                    <li class=transition3>
                                        <a class="font-size13 gray-black transition3 hover-color-green" href="../ar/pages/2.html">
                        ...
                        <div class=shop-inset>
                            ...
                            <div class="float-left-jq content-product">
                                <div class="products-aside products">
                                    <div class="product float-left-jq img-2-hover-1">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/2-kime-tea-caddy-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Kime Tea Caddy</a></h4>
                                    ...
                                    <div class="product float-left-jq img-2-hover-2">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/3-oak-wooden-chair-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Oak Wooden Chair</a></h4>
                                    ...
                                    <div class="product float-left-jq img-2-hover-3">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/4-oak-coat-stand-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Oak Coat Stand</a></h4>
                                    ...
                                    <div class="product float-left-jq img-2-hover-4">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img data-img-one="../images/shop/5-earphone-case-370x370.jpg" data-img-two="../images/shop/1-earphone-case-2-370x370.jpg">
<img src="../images/shop/5-earphone-case-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Earphone Case</a></h4>
                                                <div class=price>$12.00 <span class=sale>$22.00</span></div>
                                                <ul class=color-product>
                                                    <li class="float-left-jq active" style="background-color: #b2b2b2">
                                                    </li>
                                                    <li class=float-left-jq style="background-color: #ff0000"></li>
                                                </ul>
                                                <p>Donec accumsan auctor iaculis. Sed suscipit arcu ligula, at egestas magna molestie a. Proin ac ex maximus, ultrices justo eget, sodales orci. Aliquam egestas libero ac turpis pharetra, in vehicula lacus scelerisque. Vestibulum ut sem laoreet, feugiat tellus at, hendrerit arcu.</p>
                                    ...
                                    <div class="product float-left-jq img-2-hover-5">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/6-ottoman-chair-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Ottoman Chair</a></h4>
                                    ...
                                    <div class="product float-left-jq img-2-hover-6">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/7-mikiya-horison-table-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Horison Table</a></h4>
...
<span class=img-hover></span>
                                    ...
                                    <div class="product float-left-jq img-2-hover-10">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/11-mikiya-yc5-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Beetle Velvet Chair</a></h4>
                                    ...
                                    <div class="product float-left-jq img-2-hover-11">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/12-mikiya-phone-case-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Phone Case</a></h4>
