                            ...
                            <li class="float-left-jq hover-color-green">
                                ...
                                <ul class=transition3>
                                    <li class=transition3>
                                        <a class="font-size13 gray-black transition3 hover-color-green" href=5.html>
<img src="../images/home/1-1.jpg" alt="sorry web not allowed image"/>
English
</a>
                                    </li>
                                    <li class=transition3>
                                        <a class="font-size13 gray-black transition3 hover-color-green" href="../ar/pages/5.html">
                        ...
                        <div class=shop-inset>
                            ...
                            <div class="float-left-jq content-product">
                                <div class="products-aside products">
                                    <div class="product float-left-jq img-5-hover-1">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/2-pro11-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Graffiti backpack</a></h4>
...
<span class=img-hover></span>
                                    ...
                                    <div class="product float-left-jq img-5-hover-3">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/4-pro15-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Hashtag Display Shelf</a></h4>
                                                <div class=price>$26.00 <span class=sale>$29.00</span></div>
                                                <p>Donec accumsan auctor iaculis. Sed suscipit arcu ligula, at egestas magna molestie a. Proin ac ex maximus, ultrices justo eget, sodales orci. Aliquam egestas libero ac turpis pharetra, in vehicula lacus scelerisque. Vestibulum ut sem laoreet, feugiat tellus at, hendrerit arcu.</p>
                                                <a href="#" class="cap add transition3">add to cart</a>
                                            </div>
                                        </div>
...
<span class=img-hover></span>
                                    ...
                                    <div class="product float-left-jq img-5-hover-5">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/6-7-1-1-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Takashi Flower Vase</a></h4>
...
<span class=img-hover></span>
                                    ...
                                    <div class="product float-left-jq img-5-hover-10">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/11-pro8-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Striped bucket backpack</a></h4>
                                ...
                                <div class=control>
                                    ...
                                    <ol class=float-left-jq>
                                        ...
                                        <li class=float-left-jq><a href="4.html#scroll-product">4</a></li>
                                        <li class="float-left-jq active"><span>5</span></li>
                                    </ol>
