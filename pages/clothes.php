                            ...
                            <li class="float-left-jq hover-color-green">
                                ...
                                <ul class=transition3>
                                    <li class=transition3>
                                        <a class="font-size13 gray-black transition3 hover-color-green" href=clothes.html>
<img src="../images/home/1-1.jpg" alt="sorry web not allowed image"/>
English
</a>
                                    </li>
                                    <li class=transition3>
                                        <a class="font-size13 gray-black transition3 hover-color-green" href="../ar/pages/clothes.html">
...
<span class=img-hover></span>
                                ...
                                <div class=control>
                                    ...
                                    <ol class=float-left-jq>
                                        ...
                                        <li class=float-left-jq><a href="clothes-2.html#scroll-product">2</a></li>
                                    </ol>
