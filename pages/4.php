                            ...
                            <li class="float-left-jq hover-color-green">
                                ...
                                <ul class=transition3>
                                    <li class=transition3>
                                        <a class="font-size13 gray-black transition3 hover-color-green" href=4.html>
<img src="../images/home/1-1.jpg" alt="sorry web not allowed image"/>
English
</a>
                                    </li>
                                    <li class=transition3>
                                        <a class="font-size13 gray-black transition3 hover-color-green" href="../ar/pages/4.html">
                            ...
                            <div class="nav float-left-jq">
                                <div class=list-nav>
                                    ...
                                    <ul>
                                        ...
                                        <li class=float-left-jq>
                                            <a class="transition3 active cap color-green-black hover-color-green" href="#">Shop</a>
                                            <div class=hidden-md>
                                                <span class=transition2></span>
                                                <span class=transition2></span>
                                            </div>
...
<option value=price-desc>Sort by price: high to low</option>
                        ...
                        <div class=shop-inset>
                            <aside class=float-left-jq>
                                ...
                                <div class="size color">
                                    ...
                                    <ul class="size-ul color-ul">
                                        <li>
                                            <a href=black.html class="cap float-left-jq transition2">Black</a>
                                            <span class="count float-right-jq transition2">3</span>
                                        </li>
                                        <li>
                                            <a href=blue.html class="cap float-left-jq transition2">blue</a>
                                        ...
                                        <li>
                                            <a href=brown.html class="cap float-left-jq transition2">Brown</a>
                                            <span class="count float-right-jq transition2">1</span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href=gray.html class="cap float-left-jq transition2">Gray</a>
                                            <span class="count float-right-jq transition2">9</span>
                                        </li>
                                        <li>
                                            <a href=green.html class="cap float-left-jq transition2">Green</a>
                                            <span class="count float-right-jq transition2">1</span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href=pink.html class="cap float-left-jq transition2">Pink</a>
                                            <span class="count float-right-jq transition2">2</span>
                                        </li>
                                        <li>
                            ...
                            <div class="float-left-jq content-product">
                                <div class="products-aside products">
                                    <div class="product float-left-jq img-4-hover-1">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/2-2-1-1-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Concrete Vase</a></h4>
                                                <div class=price>$112.00 <span class=sale>$115.00</span></div>
                                    ...
                                    <div class="product float-left-jq img-4-hover-2">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/3-4-1-1-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Glass UFO Vase</a></h4>
                                    ...
                                    <div class="product float-left-jq img-4-hover-3">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/4-5-1-1-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Circle Ceramic Vase</a></h4>
                                                <div class=price>$19.99 <span class=sale>$23.99</span></div>
                                                <p>Donec accumsan auctor iaculis. Sed suscipit arcu ligula, at egestas magna molestie a. Proin ac ex maximus, ultrices justo eget, sodales orci. Aliquam egestas libero ac turpis pharetra, in vehicula lacus scelerisque. Vestibulum ut sem laoreet, feugiat tellus at, hendrerit arcu.</p>
                                                <a href="#" class="cap add transition3">add to cart</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="product float-left-jq img-4-hover-4">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/5-7-1-2-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Beat Fat Pendant Light</a></h4>
                                    ...
                                    <div class="product float-left-jq img-4-hover-5">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/6-pro2-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Basic Sweater</a></h4>
                                    ...
                                    <div class="product float-left-jq img-4-hover-6">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/7-pro3-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Faded Color Cap</a></h4>
                                                <div class=price>$19.90 <span class=sale>$34.90</span></div>
                                                <p>Donec accumsan auctor iaculis. Sed suscipit arcu ligula, at egestas magna molestie a. Proin ac ex maximus, ultrices justo eget, sodales orci. Aliquam egestas libero ac turpis pharetra, in vehicula lacus scelerisque. Vestibulum ut sem laoreet, feugiat tellus at, hendrerit arcu.</p>
                                                <a href="#" class="cap add transition3">Add to Cart</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="product float-left-jq img-4-hover-7">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/8-pro9-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Slub Knit Polo Shirt</a></h4>
                                                <div class=price>$19.50 <span class=sale>$39.90</span></div>
                                                <p>Donec accumsan auctor iaculis. Sed suscipit arcu ligula, at egestas magna molestie a. Proin ac ex maximus, ultrices justo eget, sodales orci. Aliquam egestas libero ac turpis pharetra, in vehicula lacus scelerisque. Vestibulum ut sem laoreet, feugiat tellus at, hendrerit arcu.</p>
                                                <a href="#" class="cap add transition3">add to cart</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="product float-left-jq img-4-hover-8">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img data-img-one="../images/shop/9-7-1-370x370.jpg" data-img-two="../images/shop/1-7-2-4-370x370.jpg">
<img src="../images/shop/9-7-1-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Short Sleeve T-Shirt</a></h4>
                                                <div class=price>$53.40 <span class=sale>$52.35</span></div>
                                    ...
                                    <div class="product float-left-jq img-4-hover-9">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/10-pro19-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Storage cabinet Skoll</a></h4>
                                    ...
                                    <div class="product float-left-jq img-4-hover-10">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/11-pro13-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Raw Edge Skinny Jeans</a></h4>
                                                <div class=price>$45.50 <span class=sale>$49.90</span></div>
                                                <p>Donec accumsan auctor iaculis. Sed suscipit arcu ligula, at egestas magna molestie a. Proin ac ex maximus, ultrices justo eget, sodales orci. Aliquam egestas libero ac turpis pharetra, in vehicula lacus scelerisque. Vestibulum ut sem laoreet, feugiat tellus at, hendrerit arcu.</p>
                                                <a href="#" class="cap add transition3">Add to Cart</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="product float-left-jq img-4-hover-11">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/12-pro1-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Sunday Print T-Shirt</a></h4>
                                ...
                                <div class=control>
                                    ...
                                    <ol class=float-left-jq>
                                        <li class=float-left-jq><a href="../shop.html#scroll-product">1</a></li>
                                        <li class=float-left-jq><a href="2.html#scroll-product">2</a></li>
                                        <li class=float-left-jq><a href="3.html#scroll-product">3</a></li>
                                        <li class="float-left-jq active"><span>4</span></li>
                                        <li class=float-left-jq><a href="5.html#scroll-product">5</a></li>
                                    </ol>
