                            ...
                            <li class="float-left-jq hover-color-green">
                                ...
                                <ul class=transition3>
                                    <li class=transition3>
                                        <a class="font-size13 gray-black transition3 hover-color-green" href=furniture.html>
<img src="../images/home/1-1.jpg" alt="sorry web not allowed image"/>
English
</a>
                                    </li>
                                    <li class=transition3>
                                        <a class="font-size13 gray-black transition3 hover-color-green" href="../ar/pages/furniture.html">
                            ...
                            <aside class=float-left-jq>
                                ...
                                <div class="size color">
                                    ...
                                    <ul class="size-ul color-ul">
                                        ...
                                        <li>
                                            <a href="#" class="cap float-left-jq transition2">Green</a>
                                            <span class="count float-right-jq transition2">1</span>
                                        </li>
                                        <li>
...
<span class=img-hover></span>
                                ...
                                <div class=control>
                                    ...
                                    <ol class=float-left-jq>
                                        ...
                                        <li class=float-left-jq><a href="furniture-2.html#scroll-product">2</a></li>
                                    </ol>
