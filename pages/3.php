<?php 
 ...
 ?>
    ...
    <div class=panel id=scroll-shop>
                            ...
                            <li class="float-left-jq hover-color-green">
                                ...
                                <ul class=transition3>
                                    <li class=transition3>
                                        <a class="font-size13 gray-black transition3 hover-color-green" href=3.html>
<img src="../images/home/1-1.jpg" alt="sorry web not allowed image"/>
English
</a>
                                    </li>
                                    <li class=transition3>
                                        <a class="font-size13 gray-black transition3 hover-color-green" href="../ar/pages/3.html">
                        ...
                        <div class=shop-inset>
                            ...
                            <div class="float-left-jq content-product">
                                <div class="products-aside products">
                                    <div class="product float-left-jq img-3-hover-1">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/2-mikiya-takata-lemnos-clock-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Takata Lemnos Clock</a></h4>
                                                <div class=price>$39.00 <span class=sale>$42.00</span></div>
...
<span class=img-hover></span>
                                    ...
                                    <div class="product float-left-jq img-3-hover-3">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/4-mikiya-kime-flower-vase-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Kime Flower Vase</a></h4>
...
<span class=img-hover></span>
                                    ...
                                    <div class="product float-left-jq img-3-hover-5">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/6-mikiya-yamanami-sofa-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Yamanami Sofa</a></h4>
                                    ...
                                    <div class="product float-left-jq img-3-hover-6">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/7-1-1-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Invisible Vase</a></h4>
                                                <div class=price>$9.00 <span class=sale>$18.00</span></div>
                                                <p>Donec accumsan auctor iaculis. Sed suscipit arcu ligula, at egestas magna molestie a. Proin ac ex maximus, ultrices justo eget, sodales orci. Aliquam egestas libero ac turpis pharetra, in vehicula lacus scelerisque. Vestibulum ut sem laoreet, feugiat tellus at, hendrerit arcu.</p>
                                                <a href="#" class="cap add transition3">Add to Cart</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="product float-left-jq img-3-hover-7">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/8-1-1-2-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Type 75 Maxi</a></h4>
                                    ...
                                    <div class="product float-left-jq img-3-hover-8">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/9-3-1-2-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Veneto Wooden Pendant Light</a></h4>
                                                <div class=price>$137.99 <span class=sale>$149.95</span></div>
                                                <p>Donec accumsan auctor iaculis. Sed suscipit arcu ligula, at egestas magna molestie a. Proin ac ex maximus, ultrices justo eget, sodales orci. Aliquam egestas libero ac turpis pharetra, in vehicula lacus scelerisque. Vestibulum ut sem laoreet, feugiat tellus at, hendrerit arcu.</p>
                                                <a href="#" class="cap add transition3">add to cart</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="product float-left-jq img-3-hover-9">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/10-4-1-2-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Terho &amp; Tatti Lamps</a></h4>
...
<span class=img-hover></span>
                                    ...
                                    <div class="product float-left-jq img-3-hover-11">
                                        <div class=product-aside>
                                            <div class=img-out>
                                                <a href="#" class=img>
<img src="../images/shop/12-6-1-2-370x370.jpg" alt=prod1 />
<span class=img-hover></span>
</a>
                                                <ul class=social-product>
                                                    <li class="">
                                            ...
                                            <div class=p-content>
                                                <h4><a href="#" class=transition3>Slope Pendant Lights</a></h4>
                                ...
                                <div class=control>
                                    ...
                                    <ol class=float-left-jq>
                                        ...
                                        <li class="float-left-jq active"><span>3</span></li>
