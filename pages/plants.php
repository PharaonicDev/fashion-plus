                            ...
                            <li class="float-left-jq hover-color-green">
                                ...
                                <ul class=transition3>
                                    <li class=transition3>
                                        <a class="font-size13 gray-black transition3 hover-color-green" href=plants.html>
<img src="../images/home/1-1.jpg" alt="sorry web not allowed image"/>
English
</a>
                                    </li>
                                    <li class=transition3>
                                        <a class="font-size13 gray-black transition3 hover-color-green" href="../ar/pages/plants.html">
                            ...
                            <div class="nav float-left-jq">
                                <div class=list-nav>
                                    ...
                                    <ul>
                                        ...
                                        <li class=float-left-jq>
                                            <a class="transition3 active color-green-black cap hover-color-green" href="../shop.html">Shop</a>
                                            <div class=hidden-md>
                                                <span class=transition2></span>
                                                <span class=transition2></span>
                                            </div>
